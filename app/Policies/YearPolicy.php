...
class YearPolicy
{
    ...
    {
       return $user->hasPermissionTo('Year View');
    }
    ...
    {
        return $user->hasPermissionTo('Year Create');
    }
    ...
    {
        return $user->hasPermissionTo('Year Update');
    }
    ...
    {
          return $user->hasPermissionTo('Year Delete');
    }
