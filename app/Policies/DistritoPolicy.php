...
class DistritoPolicy
{
    ...
    {
         return $user->hasPermissionTo('Distrito List');
    }
    ...
    {
        return $user->hasPermissionTo('Distrito Create');
    }
    ...
    {
        return $user->hasPermissionTo('Distrito Update');
    }
    ...
    {
        return $user->hasPermissionTo('Distrito Delete');
    }
