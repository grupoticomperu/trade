    ...
    <form method="POST" action="{{ route('admin.roles.update', $role) }}" >
        ...
        <div
                    ...
                    <div class="card-body box-profile">
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <x-input type="text" name="display_name" value="{{ old('display_name', $role->display_name) }}"
                                    placeholder="Nombre del Rol" class="w-full" />
                                <x-input-error for="display_name" />
                            </div>

                            <x-danger-button class="mt-4 mb-3" type="submit">
            ...
            <div class="px-3 py-4 bg-white md:col-span-2">
                ...
                {{-- <x-danger-button class="mt-4 mb-3" type="submit">
                    <i class="mx-2 fa-regular fa-floppy-disk"></i> Actualizar Permisos del Rol
                </x-danger-button> --}}
