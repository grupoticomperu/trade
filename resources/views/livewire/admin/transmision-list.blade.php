<div wire:lazy>
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
        <x-table>
            <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                ...
                @livewire('admin.transmision-create')
            </div>

            @if (count($transmisions))
                        ...
                        @foreach ($transmisions as $trans)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <a wire:click="edit({{ $trans->id }})" class="mr-1 btn btn-green">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <a class="btn btn-red" wire:click="confirmarEliminado({{ $trans->id }})">
    ...
    <x-slot name="footer">
        <h2 class="text-xl font-semibold leading-tight text-gray-600">Pie</h2>
    </x-slot>

    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">Modificando la Transmisión</x-slot>
