<div wire:lazy>
                        ...
                        @foreach ($etapas as $etapa)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <a wire:click="edit({{ $etapa->id }})" class="mr-1 btn btn-green">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <a class="btn btn-red" wire:click="confirmarEliminado({{ $etapa->id }})">
    ...
    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">Modificando la Etapa</x-slot>
        ...
        <x-slot name="content">
            ...
            <div class="mb-4">
                <x-label value="Orden" />
                <x-input type="number" class="w-full" wire:model="order" />
