<div wire:lazy>
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
        <x-table>
            <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                ...
                @livewire('admin.traccion-create')
            </div>
                        ...
                        @foreach ($traccions as $traccion)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <a wire:click="edit({{ $traccion->id }})" class="mr-1 btn btn-green">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <a class="btn btn-red" wire:click="confirmarEliminado({{ $traccion->id }})">
    ...
    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">Modificando la Tracción</x-slot>
