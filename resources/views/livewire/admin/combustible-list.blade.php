<div wire:lazy>
    ...
    <div class="container py-12 mx-auto border-gray-400 max-w-7xl sm:px-6 lg:px-8">
        <x-table>
            <div class="items-center px-6 py-4 bg-gray-200 sm:flex">
                ...
                @livewire('admin.combustible-create')
            </div>
                        ...
                        @foreach ($combustibles as $comb)
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <a wire:click="edit({{ $comb->id }})" class="mr-1 btn btn-green">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <a class="btn btn-red" wire:click="confirmarEliminado({{ $comb->id }})">
    ...
    <x-dialog-modal wire:model="open_edit">
        <x-slot name="title">Modificando el Combustible</x-slot>
